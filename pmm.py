...
class Ipgs(object):
    def __init__(self, booleans_folder, new = False):
        """
        mm: tuple
        ...
        if new:
            ...
            suffixes = [('data_al1_ultrarare.csv','_ultrarare_al1'),
                    ('data_al2_ultrarare.csv','_ultrarare_al2'),
                    ('data_al1_just_rare.csv','_just_rare_al1'),
                    ('data_al2_just_rare.csv','_just_rare_al2'),
                    ('data_al1_just_medium.csv','_just_medium_al1'),
                    ('data_al2_just_medium.csv','_just_medium_al2'),
                    ('data_gc_unique_hetero.csv',''),
                    ('data_gc_unique_homo.csv','_homo')]
        self.indexes = set()
